...
# Debugging: Print out available secrets keys
st.write("Available secrets keys:", list(st.secrets.keys()))

# Check if the API key is available
if "togetherai_api_key" not in st.secrets:
    st.error("API key for TogetherAI not found. Please check your secrets configuration.")
else:
